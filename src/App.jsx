    ...
    <>
      ...
      <nav className="flex items-center justify-between px-6 py-5 md:px-16
        ...
        <div className="text-2xl font-black tracking-widest uppercase">
          <span className="text-white">VAL</span><span className="text-red-500">ORANT</span>
        </div>

        <ul className="hidden md:flex gap-8 text-sm font-semibold
                    uppercase items-center text-zinc-300">
          <li>
            <a href="#" className="tracking-wide transition hover:text-red-500">Home</a>
          </li>
          <li>
            <a href="#" className="tracking-wide transition hover:text-red-500">Agents</a>
          </li>
          <li>
            <a href="#" className="tracking-wide transition hover:text-red-500">Maps</a>
          </li>
          <li>
            <a href="#" className="tracking-wide transition hover:text-red-500">Ranked</a>
          </li>
          <li>
            <a href="#" className="tracking-wide transition hover:text-red-500">News</a>
          </li>
        </ul>
        <a href="#" className="hidden md:inline-block bg-red-600 text-white px-6 py-2
      ...
      <section className="relative bg-zinc-950 px-6 md:px-16 py-24
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start">
          ...
          <h1
            ...
            <span className="block mt-3">
              <span className="text-white">The </span><span className="text-red-500">Limits</span>
            </span>
          </h1>
          <p className="mb-10 max-w-[590px] text-base md:text-lg leading-relaxed text-zinc-400">
            A 5v5 character-based tactical shooter. Precise gunplay meets
            unique agent abilities in every round.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center
                       md:justify-start">
            <a href="#" className="bg-red-600 text-white px-8 py-3 font-bold uppercase
                         tracking-wide hover:bg-red-700 transition text-center">
              Play For Free
            </a>

            <a href="#" className="border border-zinc-600 px-8 py-3 font-bold uppercase
        ...
        <div className="w-full md:w-1/2 h-72 md:h-[480px]">
          <img src={reyna} alt="Reyna" className="w-full h-full object-cover border border-zinc-700"/>
        </div>
      </section>
      ...
      <section className="bg-zinc-950 border-b border-zinc-800 px-6 py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-zinc-400 text-base md:text-lg leading-relaxed">
            Every agent brings a unique set of abilities. Master your role and outplay the
            enemy team.
          </p>
      ...
      <section className="bg-zinc-950 px-6 md:px-14 py-6 pb-20 border-b border-zinc-800">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-zinc-900 border border-zinc-800 px-9 py-9 min-h-[228px] hover:border-red-600">
            <div className="w-[52px] h-[52px] border border-red-600
            ...
            <p className="text-zinc-400 text-base leading-relaxed">
              Self-sufficient fraggers who create and take space for their team to
              advance.
            </p>
          </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 px-9 py-9 min-h-[228px] hover:border-red-600">
            ...
            <p className="text-zinc-400 text-base leading-relaxed">
              Area-denial specialists who cut off sightlines and control the pace of
              engagements.
            </p>
          </div>
      ...
      <section className="bg-black px-6 md:px-14 py-20
        ...
        <div className="w-full">
          ...
          <p className="text-zinc-400 text-base md:text-lg
            ...
            From tight corridors to wide-open sightlines, every map is built around
            tactical positioning, sound cues, and split-second decisions.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-11">
          ...
          <div className="bg-black/20 border border-white/20 p-11">
            <p className="text-lg leading-relaxed mb-14">
              "Every match feels different. The abilities completely
          ...
          <div className="bg-black/20 border border-white/20 p-11">
            <p className="text-lg leading-relaxed mb-8">
              "The gunplay is unmatched. Clean, precise, and
              rewards actual aim skill."
            </p>
          ...
          <div className="bg-black/20 border border-white/20 p-11">
            <p className="text-lg leading-relaxed mb-8">
              "Best free-to-play shooter out there. The agent
              variety keeps it fresh every season."
            </p>
      ...
      <section className="px-6 md:px-16 py-20 text-center bg-zinc-950">
        ...
        <a href="#" className="inline-block bg-red-600 text-white px-10 py-3
      ...
      <footer
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="mb-4 font-black uppercase text-white">
              Valorant
            </h3>
          ...
          <div className="flex flex-col">
            <a href="#" className="mb-2 text-sm hover:text-red-500">Agents</a>
            <a href="#" className="mb-2 text-sm hover:text-red-500">Maps</a>
            <a href="#" className="mb-2 text-sm hover:text-red-500">Ranked</a>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col">
              <a href="#" className="mb-2 text-sm hover:text-red-500">Patch Notes</a>
              <a href="#" className="mb-2 text-sm hover:text-red-500">Esports</a>
              <a href="#" className="mb-2 text-sm hover:text-red-500">Support</a>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col">
              <a href="#" className="mb-2 text-sm hover:text-red-500">support@valorant.com</a>
              <a href="#" className="mb-2 text-sm hover:text-red-500">Riot Games Inc.</a>
              <a href="#" className="mb-2 text-sm hover:text-red-500">Los Angeles, CA</a>
            </div>
        ...
        <div
          ...
          © 2026 Riot Games, Inc. Fan-made practice project — not affiliated with Riot Games.
        </div>
      </footer>
    </>
  );
